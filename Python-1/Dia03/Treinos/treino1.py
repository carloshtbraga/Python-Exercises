...
# entrada (numbers) o nosso laço for irá percorrer cada elemento
...
# elemento em memória. A variável result será responsável
# por armazenar o resultado numérico de nossa operação de
# multiplicação. Por isso, nossa complexidade espacial é O(1).
